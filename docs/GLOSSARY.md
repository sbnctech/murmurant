...
| **Template** | Reusable content structure (emails, documents) using brand tokens. |
| **Chatbot Personality** | Brand's chatbot name, avatar, personality, suggested prompts. |
| **Terminology** | Brand-specific word choices (event vs activity). |
